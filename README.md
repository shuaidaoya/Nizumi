...
A: 超分辨率功能对 GPU 性能要求较高, 如果没有在高性能独立显卡上运行 Nizumi, 尽量选择效率档而非质量档。对低分辨率视频源而非高分辨率视频源使用超分也可以降低性能消耗。
...
A: 部分视频源的番剧使用了反盗链措施, 这可以被 Nizumi 解决, 但无法被外部播放器解决。
...
特别感谢原项目 [Predidit/Kazumi](https://github.com/Predidit/Kazumi) 本项目基于其二次开发。
