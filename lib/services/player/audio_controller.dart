  ...
  Future<void> _initialize() async {
    ...
    if (Platform.isLinux) {
      AudioServiceMpris.init(
        dBusName: 'io.github.Predidit.Nizumi.channel.audio',
        identity: 'Nizumi Playback',
        canControl: true,
        canPlay: true,
        canPause: true,
        canGoNext: true,
    ...
    await AudioService.init(
      ...
      config: const AudioServiceConfig(
        androidNotificationChannelId: 'io.github.Predidit.Nizumi.channel.audio',
        androidNotificationChannelName: 'Nizumi Playback',
